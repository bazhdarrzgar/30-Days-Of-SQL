-- Some Note
 -- 1. Case sensitive in sql is off
 -- 2. use simicolon ( ; ) in the end of all the action if you use more than one block of code to 
   -- * simicolon (;) help you when you run all the code in one time, then it sparate this block one by one when run all the code
